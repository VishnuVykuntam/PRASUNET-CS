...
if choice == 1:
    ...
    if choice not in [1,0]:
        print("unknown value entered, error")
        exit()
    if choice ==1: 
        print("enter shift value")
        val=int(input())
        ...
        print("shift value unknown, taking the most occuring character as 'e'") 
        # in english, the most occured alphabet across all words is 'e'
